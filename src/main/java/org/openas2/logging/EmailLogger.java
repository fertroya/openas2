...
public class EmailLogger extends BaseLogger {
    ...
    protected CompositeParameters createParser(Message msg, OpenAS2Exception exception,
        boolean terminated) {
    ...
    protected String parseText(OpenAS2Exception exception, boolean terminated, String text)
        ...
        Message msg = (Message) exception.getSource(OpenAS2Exception.SOURCE_MESSAGE);
    ...
    protected String parseText(Message msg, String text)
        throws InvalidParameterException {
